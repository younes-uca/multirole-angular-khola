...
export class PurchaseListAdminComponent extends AbstractListController<PurchaseDto, PurchaseCriteria, PurchaseAdminService>  implements OnInit, AfterViewInit {
    ...
    constructor( private purchaseService: PurchaseAdminService  , private cdRef: ChangeDetectorRef  , private clientService: ClientAdminService, private purchaseItemService: PurchaseItemAdminService, private productService: ProductAdminService) {
