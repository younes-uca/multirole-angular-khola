...
import { CommunSuperadminModule } from './view/commun/commun-superadmin.module';
import { CommunSuperadminRoutingModule } from './view/commun/commun-superadmin-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  CommunSuperadminModule,
  CommunSuperadminRoutingModule,
  ],
  exports: [
  LoginSuperadminComponent,
  RegisterSuperadminComponent,
