package  emsi.sir.oubala.ws.facade.superadmin.commun;
...
@RestController
@RequestMapping("/api/superadmin/clientCategory/")
public class ClientCategoryRestSuperadmin  extends AbstractController<ClientCategory, ClientCategoryDto, ClientCategoryHistory, ClientCategoryCriteria, ClientCategoryHistoryCriteria, ClientCategorySuperadminService, ClientCategoryConverter> {
    ...
    public ClientCategoryRestSuperadmin (ClientCategorySuperadminService service, ClientCategoryConverter converter) {
