...
@RestController
@RequestMapping("/api/superadmin/client/")
public class ClientRestSuperadmin  extends AbstractController<Client, ClientDto, ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientSuperadminService, ClientConverter> {
    ...
    public ClientRestSuperadmin (ClientSuperadminService service, ClientConverter converter) {
