...
import java.util.List;
@Service
public class ClientCategorySuperadminServiceImpl extends AbstractServiceImpl<ClientCategory,ClientCategoryHistory, ClientCategoryCriteria, ClientCategoryHistoryCriteria, ClientCategoryDao,
ClientCategoryHistoryDao> implements ClientCategorySuperadminService {
...
public static final List<Attribute> ATTRIBUTES = new ArrayList();
    ...
    public ClientCategorySuperadminServiceImpl(ClientCategoryDao dao, ClientCategoryHistoryDao historyDao) {
